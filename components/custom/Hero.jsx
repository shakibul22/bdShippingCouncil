...
const Hero = () => {
  ...
  return (
    <>
      {latestNews && (
        <div className="relative w-full h-screen sm:h-screen md:h-screen lg:h-screen xl:h-screen">
          <video
            autoPlay
            loop
            muted
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div className="relative flex justify-start items-start transform translate-x-16  translate-y-12 md:-translate-y-4 lg:translate-x-[53%] lg:translate-y-11 z-40 3xl:translate-y-20">
              ...
              <div>
                <div
                  className="rounded-lg border-t-2 border-t-slate-50 h-auto p-3 3xl:p-6 bg-opacity-70 w-[180px] md:w-[280px] 3xl:w-full max-w-sm md:max-w-lg 3xl:max-w-screen-sm lg:w-full text-start z-50"
                  style={{
                    background:
                ...
                >
                  ...
                  {latestNews.length > 0 && (
                    <motion.p
                      ...
                      className="mt-3 "
                    >
                      <span className="font-bold text-xl text-[#d0d5d9]">
                        “
                      </span>
                      <span
                        className="leading-[1px] lg:leading-[1.50] text-[#d0d5d9] text-[12px] md:text-[16px] 3xl:text-[20px]"
                        style={{
                      ...
                      <span className="font-bold text-[#d0d5d9] text-xl">
                        ”
                      </span>
                    </motion.p>
                  )}
