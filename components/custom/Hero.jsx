...
const Hero = () => {
  const { latestNews,currentIndex,setCurrentIndex ,direction,setDirection} = useContext(context);
  ...
  return (
    <div className="relative w-full h-screen sm:h-[70vh] md:h-[45vh] lg:h-screen 3xl:h-screen bg-[url('')]">
      ...
      <div className="absolute inset-0 flex items-center justify-end">
        ...
        <div className="relative rounded-lg h-[180px] bg-gradient-to-r from-gray-900 to-gray-0 bg-opacity-70 p-3 sm:p-6 right-6 w-[200px] lg:w-full sm:right-16 md:right-24 lg:right-[22%] top-4 sm:top-8 md:top-12 lg:top-16 text-white text-start max-w-sm sm:max-w-md md:max-w-lg z-20">
