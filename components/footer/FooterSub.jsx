    ...
    <div className="flex-1 flex flex-col gap-12 ">
      ...
      <div className="flex flex-col gap-5 ">
        <div>
          ...
          <p className="text-[#6f8699] text-sm lg:text-lg mt-1">
            Subscribe to out newsletter and stay updated
          </p>
        </div>
        <form
          className="bg-[#FFF0F0] text-[#1b405d] w-[305px] sm:w-[315px] lg:w-full flex flex-row justify-between px-5 p-2 rounded-lg bg-opacity-25  text-sm"
          onSubmit={handleSub}
        >
          <input
            type="email"
          ...
          <button
            type="submit"
            className=" bg-secondaryColor text-slate-300 w-10 h-10 p-2 transform lg:translate-x-0 -translate-x-4 rounded-full"
            // onClick={handleSub}
            disabled={sending}
          >
            {" "}
