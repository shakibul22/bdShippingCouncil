...
const BreifLayout = async () => {
  ...
  return (
    <div className="px-2 py-6 max-w-screen-2xl mx-auto ">
      <div className="text-sm lg:text-base flex flex-col gap-8 md:flex-row">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 mt-4 gap-4 flex-1">
