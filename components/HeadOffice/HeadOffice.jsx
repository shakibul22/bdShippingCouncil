...
const HeadOffice = () => {
  return (
    <div className="relative bg-[url('/img/mapbg.png')] bg-cover  bg-center h-auto lg:h-[300px]  max-w-7xl  gap-4 mx-auto py-10 my-10 flex flex-col lg:flex-row items-center justify-between rounded-lg shadow-lg">
      <div className="px-8">
