...
const HeadOffice = () => {
  return (
    <div className="relative bg-[url('/img/office.png')]  bg-cover px-3   bg-center h-auto lg:h-[300px]  w-full lg:max-w-5xl 3xl:max-w-7xl gap-4 mx-auto py-10 my-10 flex flex-col lg:flex-row items-center justify-between rounded-lg shadow-lg">
      <div className="px-8">
