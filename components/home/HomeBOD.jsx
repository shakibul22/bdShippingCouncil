      ...
      <div className="w-full lg:max-w-5xl 3xl:max-w-7xl mx-auto">
        ...
        <div>
          <Link href={"/about/officials"} className="w-[200px]">
            <p className="py-2.5 px-7 w-fit flex flex-row justify-center gap-2 leading-normal bg-btn hover:bg-white hover:border-btn hover:border hover:text-btn items-center rounded-md transition duration-500 shadow-lg mx-auto mt-12 text-white font-semibold">
